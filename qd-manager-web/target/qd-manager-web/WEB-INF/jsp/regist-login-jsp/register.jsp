...
<head>
    ...
    <title>注册-个人用户</title>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/regist-login-css/headerfooter.css" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/regist-login-css/jquery.alerts.css" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/regist-login-css/headerfooterindex.css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/js/regist-login-js/jquery-1.5.1.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/regist-login-js/jquery.cookie.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/regist-login-js/passport.common.js?v20140531"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/regist-login-js/jquery.alerts.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/regist-login-js/png.js?v20140521"></script>
</head>
<body>
		<!-- header -->
		<div class="header">
			<a href="http://www.e3mall.cn"><img src="/images/regist-login-images/logo.png" border="0" /><span>欢迎注册</span></a>
		</div>

		<!--mainStart-->
						<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/regist-login-css/reg.css?v20140432" />
<script type="text/javascript" src="${pageContext.request.contextPath}/js/regist-login-js/allMail.js?v20140430"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/regist-login-js/reg.js?v20150122"></script>
<!-- reg_main -->
